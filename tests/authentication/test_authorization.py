...
class TestAuthorization:
    ...
    @allure.title('User login with correct login and password')
    def test_successful_authorization(
        ...
        registration_page.registration_form.fill(email='123@te.st', username='User123', password='pass12')
        ...
        login_page.visit('https://nikita-filonov.github.io/qa-automation-engineer-ui-course/#/auth/login')
        login_page.login_form.fill(email='123@te.st', password='pass12')
        login_page.click_login_button()
